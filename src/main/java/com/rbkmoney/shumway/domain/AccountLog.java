...
public class AccountLog {
    ...
    public AccountLog(long id, long batchId, long planId, Instant creationTime, long accountId, PostingOperation operation, long ownAmount, long minAmount, long maxAmount, boolean credit, boolean merged) {
        this.id = id;
